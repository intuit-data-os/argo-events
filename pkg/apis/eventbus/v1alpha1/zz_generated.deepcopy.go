...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KfConsumerGroup) DeepCopyInto(out *KfConsumerGroup) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KfConsumerGroup.
func (in *KfConsumerGroup) DeepCopy() *KfConsumerGroup {
	if in == nil {
		return nil
	}
	out := new(KfConsumerGroup)
